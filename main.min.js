...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (href.includes('wa.me')) {
            window.trackEvent('conversion', 'whatsapp_click');
        } else if (href.includes('tel:')) {
            window.trackEvent('conversion', 'call_click');
        } else if (text.includes('test drive')) {
            window.trackEvent('conversion', 'test_drive_intent');
        } else if (text.includes('emi') || text.includes('finance') || text.includes('loan')) {
            window.trackEvent('conversion', 'finance_intent');
        }
    });
    ...
    // --- Privacy Consent Bar Implementation ---
    const initPrivacyBar = () => {
        if (localStorage.getItem('axom_consent')) return;
        ...
        style.textContent = `
            .privacy-consent-bar {
                ...
                gap: 20px;
                z-index: 10000;
                animation: slideUpConsent 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards;
            }
            ...
            .privacy-text a { color: #1d70b8; text-decoration: underline; font-weight: 500; }
            .btn-consent {
                background: #1d70b8;
                color: white;
                border: none;
            ...
            .btn-consent:hover { background: #155a96; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(29, 112, 184, 0.3); }
        ...
        bar.className = 'privacy-consent-bar';
        bar.innerHTML = `
            <p class="privacy-text">
                We use cookies and analytics to improve your experience on our site. By continuing, you agree to our 
                <a href="#">Privacy Policy</a>.
            </p>
            <button class="btn-consent" id="acceptConsent">Accept & Close</button>
        `;
        document.body.appendChild(bar);

        document.getElementById('acceptConsent').addEventListener('click', () => {
            localStorage.setItem('axom_consent', 'true');
    ...
    setTimeout(initPrivacyBar, 2000);
});
